...
- **Tools** — builtin, shared, and per-agent toolkits with auto-discovery, auto-retry on transient errors, and result summarization
...
- **Cost tracking** — per-model USD cost estimates, daily cost alerts, and dashboard cost views
- **Alerting** — Discord webhook alerts for error spikes, cost thresholds, and agent crashes
